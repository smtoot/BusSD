        ...
        <div class="col-lg-9 col-md-9 mb-30">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('supervisor.password.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
...
@push('breadcrumb-plugins')
    <a href="{{ route('supervisor.profile') }}" class="btn btn-sm btn-outline--primary">
