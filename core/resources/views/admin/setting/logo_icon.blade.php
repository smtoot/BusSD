                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center">
                            <div class="form-group col-md-8 col-sm-6">
                                ...
                                <x-image-uploader name="logo" :imagePath="siteLogo() . '?' . time()" :size="false" :darkMode="true" class="w-100" id="uploadLogo" :required="false" />
                            </div>
                            <div class="form-group col-md-4 col-sm-6">
                                <label> @lang('Favicon')</label>
                                <x-image-uploader name="favicon" :imagePath="siteFavicon() . '?' . time()" :size="false" :darkMode="true" class="w-100" id="uploadFavicon" :required="false" />
                            </div>
                        </div>
