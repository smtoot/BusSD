...
@section('panel')
                            ...
                            <tbody>
                                @forelse($logs as $log)
                                    <tr>
                                        <td>
                                            @if ($log->owner)
                                                <span class="fw-bold">{{ $log->owner->fullname }}</span>
                                                <br>
                                                <span class="small">
                                                    <a
                                                        href="{{ route('admin.users.detail', $log->owner_id) }}"><span>@</span>{{ $log->owner->username }}</a>
                                                </span>
                                            @else
    ...
    @push('breadcrumb-plugins')
        @if (@$owner)
            <a href="{{ route('admin.users.notification.single', $owner->id) }}" class="btn btn-outline--primary btn-sm"><i
