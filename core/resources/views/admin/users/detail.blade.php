                ...
                <div class="card-body">
                    <form action="{{ route('admin.users.update', [$user->id]) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>@lang('App Commission Override (%)') <small class="text--small text--muted">(@lang('Leave empty to use Global Rate'))</small></label>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('admin.users.status', $user->id) }}" method="POST">
                    ...
                    <div class="modal-body">
                        @if ($user->status == Status::USER_ACTIVE)
                            <h6 class="mb-2">@lang('If you ban this owner he/she won\'t able to access his/her dashboard.')</h6>
                            <div class="form-group">
                        ...
                        @else
                            ...
                            <p>{{ $user->ban_reason }}</p>
                            <h4 class="text-center mt-3">@lang('Are you sure to unban this owner?')</h4>
                        @endif
                    </div>
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.users.login', $user->id) }}" target="_blank" class="btn btn-sm btn-outline--primary">
        <i class="las la-sign-in-alt"></i>@lang('Login as Owner')
    </a>
@endpush
