                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span class="fw-bold">
                                <a
                                    href="{{ route('admin.users.detail', $deposit->owner_id) }}"><span>@</span>{{ @$deposit->owner->username }}</a>
                            </span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Method')
                ...
                <form action="{{ route('admin.deposit.reject')}}" method="POST">
                    ...
                    <div class="modal-body">
                        <p>@lang('Are you sure to') <span class="fw-bold">@lang('reject')</span> <span
                                class="fw-bold text--success">{{ showAmount($deposit->amount) }}</span> @lang('payment of')
                            <span class="fw-bold">{{ @$deposit->owner->username }}</span>?</p>
