                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="starting_point" class="form-control select2" required>
                                        ...
                                        @foreach ($counters as $counter)
                                            <option value="{{ $counter->id }}" {{ $route->starting_point == $counter->id ? 'selected' : '' }}>{{ $counter->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="destination_point" class="form-control select2" required>
                                        <option value="">@lang('Select One')</option>
                                        @foreach ($counters as $counter)
                                            <option value="{{ $counter->id }}" {{ $route->destination_point == $counter->id ? 'selected' : '' }}>{{ $counter->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="time" class="form-control" value="{{ $route->time }}" placeholder="@lang('Example: 5')" />
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="stoppages[]" class="form-control select2" multiple>
                                        @foreach ($counters as $counter)
                                            <option value="{{ $counter->id }}" {{ in_array($counter->id, $route->stoppages ?? []) ? 'selected' : '' }}>{{ $counter->name }}</option>
                                        @endforeach
                                    </select>
