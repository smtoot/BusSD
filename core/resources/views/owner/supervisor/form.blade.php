...
@section('panel')
    <div class="row mb-none-30">
        <div class="col-xl-12 col-lg-8 mb-30">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('owner.supervisor.store', @$user->id) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <x-image-uploader image="{{ @$user->image }}" class="w-100" type="supervisor"
                                        :required="false" />
                                </div>
                            </div>
...
@push('breadcrumb-plugins')
    @if (@$user->id && auth()->guard('owner')->user())
        <a href="{{ route('owner.supervisor.login', @$user->id) }}" class="btn btn-sm btn-outline--primary">
            <i class="las la-sign-in-alt"></i>@lang('Login as Supervisor')
        </a>
    @endif
    <x-back route="{{ route('owner.supervisor.index') }}" />
@endpush
