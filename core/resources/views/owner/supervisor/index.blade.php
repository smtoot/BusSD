                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="{{ route('owner.supervisor.form', $supervisor->id) }}"
                                                ...
                                                @if ($supervisor->status == Status::DISABLE)
                                                    <button class="btn btn-sm btn-outline--success confirmationBtn"
                                                        ...
                                                        data-action="{{ route('owner.supervisor.status', $supervisor->id) }}">
...
@push('breadcrumb-plugins')
    <x-search-form />
    <a href="{{ route('owner.supervisor.form') }}" class="btn btn-outline--primary">
