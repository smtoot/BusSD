        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body ">
                    ...
                    <form action="{{ route('owner.ticket.reply', $myTicket->id) }}" enctype="multipart/form-data"
                        ...
                        @if ($message->admin_id == 0)
                            <div class="row border border--primary border-radius-3 my-3 mx-0">
                                <div class="col-md-3 border-end text-md-end text-start">
                                    ...
                                    @if ($myTicket->owner_id != null)
                                        <p>
                                            <a href="{{ route('admin.users.detail', $myTicket->owner_id) }}">
                                                &#64;{{ $myTicket->name }}
                                            </a>
                                        </p>
                                    @else
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('owner.ticket.close', $myTicket->id) }}">
                        @csrf
