    ...
    <div class="login-main" style="background-image: url('{{ asset('assets/admin/images/login.jpg') }}')">
        <div class="container custom-container d-flex justify-content-center">
            <div class="login-area">
                ...
                <form action="{{ route('owner.password.verify.code') }}" method="POST" class="login-form w-100">
                    @csrf
                    ...
                    <div class="form-group mt-3 text-white">
                        ...
                        <a href="{{ route('owner.password.request') }}" class="text-secondary">@lang('Try to send again')</a>
                    </div>
                    <div class="text-center">
                        <a href="{{ route('owner.login') }}" class="text-white"><i class="las la-sign-in-alt"></i> @lang('Back to Login')</a>
                    </div>
                </form>
            </div>
        </div>
