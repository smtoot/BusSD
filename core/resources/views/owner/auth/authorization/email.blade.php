            ...
            <div class="login-area">
                <div class="text-center mb-3">
                    ...
                    <p class="text-white mb-2">
                        @lang('A 6 digit verification code sent to your email address'):  {{ showEmailAddress(authUser()->email) }}
                    </p>
                </div>
                <form action="{{ route('owner.verify.email') }}" method="POST" class="login-form w-100">
                    @csrf
                    ...
                    <div class="d-flex flex-wrap justify-content-between mt-4">
                        <p class="text-white">
                            @lang('Don\'t get any code'), <span class="countdown-wrapper text-white">@lang('try again after') <span id="countdown" class="fw-bold text-white">--</span> @lang('seconds')</span> <a href="{{route('owner.send.verify.code', 'email')}}" class="try-again-link d-none forget-text"> @lang('Try again')</a>
                        </p>
