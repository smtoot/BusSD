                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button data-action="{{ route('owner.seat.layout.store', $seatLayout->id) }}"
                                                ...
                                                @if ($seatLayout->status == Status::DISABLE)
                                                    <button class="btn btn-sm btn-outline--success confirmationBtn"
                                                        ...
                                                        data-action="{{ route('owner.seat.layout.status', $seatLayout->id) }}">
...
@push('breadcrumb-plugins')
    <button class="btn btn-sm btn-outline--primary addBtn" data-action="{{ route('owner.seat.layout.store') }}"
