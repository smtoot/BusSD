                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="{{ route('co-owner.counter.manager.form', $manager->id) }}"
                                                ...
                                                @if ($manager->status == Status::DISABLE)
                                                    <button class="btn btn-sm btn-outline--success confirmationBtn"
                                                        ...
                                                        data-action="{{ route('co-owner.counter.manager.status', $manager->id) }}">
...
@push('breadcrumb-plugins')
    <x-search-form />
    <a href="{{ route('co-owner.counter.manager.form') }}" class="btn btn-outline--primary">
