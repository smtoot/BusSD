                            ...
                            <tbody>
                                @forelse($fleetTypes as $fleetType)
                                    <tr>
                                        ...
                                        <td>{{ collect($fleetType->seats)->sum() }}</td>
                                        <td>{{ $fleetType->has_ac ? __('AC') : __('Non AC') }}</td>
                                        <td>@php echo $fleetType->statusBadge; @endphp</td>
                                        <td>
                                            <div class="button--group">
                                                <button
                                                    data-action="{{ route('co-owner.fleet.type.store', $fleetType->id) }}"
                                                ...
                                                @if ($fleetType->status == Status::DISABLE)
                                                    <button class="btn btn-sm btn-outline--success confirmationBtn"
                                                        ...
                                                        data-action="{{ route('co-owner.fleet.type.status', $fleetType->id) }}">
...
@push('breadcrumb-plugins')
    <x-search-form />
    <button class="btn btn-sm btn-outline--primary addBtn" data-action="{{ route('co-owner.fleet.type.store') }}"
