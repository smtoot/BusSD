                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button data-action="{{ route('co-owner.counter.store', $counter->id) }}"
                                                ...
                                                @if ($counter->status == Status::DISABLE)
                                                    <button class="btn btn-sm btn-outline--success confirmationBtn"
                                                        ...
                                                        data-action="{{ route('co-owner.counter.status', $counter->id) }}">
...
@push('breadcrumb-plugins')
    <x-search-form />
    <button class="btn btn-sm btn-outline--primary addBtn" data-action="{{ route('co-owner.counter.store') }}"
