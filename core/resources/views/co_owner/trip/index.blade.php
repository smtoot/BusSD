                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="{{ route('co-owner.trip.form', $trip->id) }}"
                                                ...
                                                @if ($trip->status == Status::DISABLE)
                                                    <button class="btn btn-sm btn-outline--success confirmationBtn"
                                                        ...
                                                        data-action="{{ route('co-owner.trip.status', $trip->id) }}">
...
@push('breadcrumb-plugins')
    <x-search-form />
    <a href="{{ route('co-owner.trip.form') }}" class="btn btn-sm btn-outline--primary">
