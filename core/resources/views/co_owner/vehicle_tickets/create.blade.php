...
@section('panel')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ route('co-owner.trip.ticket.price.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div id="overlay">
...
@push('breadcrumb-plugins')
    <x-back route="{{ route('co-owner.trip.ticket.price.index') }}" />
@endpush
        ...
        (function($) {
            ...
            function getRouteData() {
                if (routeId && fleetTypeId) {
                    ...
                    $("#overlay").fadeIn(300);
                    $.ajax({
                        url: "{{ route('co-owner.trip.ticket.get_route_data') }}",
                        method: "get",
                        data: data,
