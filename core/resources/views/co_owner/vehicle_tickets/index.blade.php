                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="{{ route('co-owner.trip.ticket.price.edit', $ticketPrice->id) }}"
                                                ...
                                                @if ($ticketPrice->status == Status::DISABLE)
                                                    <button class="btn btn-sm btn-outline--success confirmationBtn"
                                                        ...
                                                        data-action="{{ route('co-owner.trip.ticket.price.status', $ticketPrice->id) }}">
...
@push('breadcrumb-plugins')
    <a href="{{ route('co-owner.trip.ticket.price.create') }}" class="btn btn-sm btn-outline--primary">
