                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button class="btn btn-sm btn-outline--primary editBtn"
                                                    data-action="{{ route('co-owner.trip.assign.vehicle.store', $assignedVehicle->id) }}"
                                                ...
                                                @if ($assignedVehicle->status == Status::DISABLE)
                                                    <button class="btn btn-sm btn-outline--success confirmationBtn"
                                                        ...
                                                        data-action="{{ route('co-owner.trip.assign.vehicle.status', $assignedVehicle->id) }}">
...
@push('breadcrumb-plugins')
    <x-search-form />
    <button class="btn btn-sm btn-outline--primary addBtn" data-action="{{ route('co-owner.trip.assign.vehicle.store') }}"
