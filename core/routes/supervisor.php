...
Route::namespace('Supervisor\Auth')->middleware('supervisor.guest')->group(function () {
    Route::controller('LoginController')->group(function () {
        Route::get('/login', 'showLoginForm')->name('login');
        Route::post('/login', 'login');
        Route::get('logout', 'logout')->middleware('supervisor')->withoutMiddleware('supervisor.guest')->name('logout');
    });
...
Route::middleware('supervisor')->namespace('Supervisor')->group(function () {
