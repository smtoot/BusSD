...
class SupportTicketController extends Controller
{
    ...
    public function tickets()
    {
        ...
        $items = SupportTicket::searchable(['name', 'subject', 'ticket'])->orderBy('id', 'desc')->with('owner')->paginate(getPaginate());
    ...
    public function pendingTicket()
    {
        ...
        $items = SupportTicket::searchable(['name', 'subject', 'ticket'])->pending()->orderBy('id', 'desc')->with('owner')->paginate(getPaginate());
        return view('admin.support.tickets', compact('items', 'pageTitle'));
    }
    ...
    public function closedTicket()
    {
        ...
        $items = SupportTicket::searchable(['name', 'subject', 'ticket'])->closed()->orderBy('id', 'desc')->with('owner')->paginate(getPaginate());
        return view('admin.support.tickets', compact('items', 'pageTitle'));
    }
    ...
    public function answeredTicket()
    {
        ...
        $items = SupportTicket::searchable(['name', 'subject', 'ticket'])->orderBy('id', 'desc')->with('owner')->answered()->paginate(getPaginate());
        return view('admin.support.tickets', compact('items', 'pageTitle'));
    }

    public function ticketReply($id)
    {
        $ticket = SupportTicket::with('owner')->where('id', $id)->firstOrFail();
