...
class FleetController extends Controller
{
    public function fleetType()
    {
        ...
        $seatLayouts = SeatLayout::active()->where('owner_id', $owner->id)->get();
        return view('co_owner.fleet_type.index', compact('pageTitle', 'fleetTypes', 'seatLayouts'));
    }
    ...
    public function seatLayout()
    {
        ...
        return view('co_owner.seat_layout.index', compact('pageTitle', 'seatLayouts', 'owner'));
    }
    ...
    public function vehicle()
    {
        ...
        return view('co_owner.vehicle.index', compact('pageTitle', 'vehicles', 'owner', 'fleetTypes'));
    }
