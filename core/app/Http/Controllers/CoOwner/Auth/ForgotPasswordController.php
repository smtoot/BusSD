...
class ForgotPasswordController extends Controller
{
    public function showLinkRequestForm()
    {
        ...
        return view('co_owner.auth.passwords.email', compact('pageTitle'));
    }
    ...
    public function sendResetCodeEmail(Request $request)
    {
        ...
        $owner = CoOwner::where($fieldType, $request->value)->first();
        if (!$owner) {
        ...
        return to_route('co-owner.password.code.verify')->withNotify($notify);
    }
    ...
    public function codeVerify()
    {
        ...
        if (!$email) {
            ...
            return to_route('co-owner.password.reset')->withNotify($notify);
        }
        return view('co_owner.auth.passwords.code_verify', compact('pageTitle', 'email'));
    }
    ...
    public function verifyCode(Request $request)
    {
        ...
        return to_route('co-owner.password.reset', $code)->withNotify($notify);
    }
