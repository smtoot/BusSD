...
trait UserNotify
{
    public static function notifyToUser(){
        return [
            'allUsers'              => 'All Owners',
            'selectedUsers'         => 'Selected Owners',
            'hasDepositedUsers'       => 'Has Paid Owners',
            'notDepositedUsers'       => 'Not Paid owners',
            'pendingDepositedUsers'   => 'Pending Payment Owners',
            'rejectedDepositedUsers'  => 'Rejected Payment Owners',
            'topDepositedUsers'     => 'Top Paid Owners',
            'pendingTicketUser'     => 'Pending Ticket Owners',
            'answerTicketUser'      => 'Answer Ticket Owners',
            'closedTicketUser'      => 'Closed Ticket Owners',
            'notLoginUsers'         => 'Last Few Days Not Login Owners',
        ];
    }
