...
CREATE TABLE `booked_tickets` (
  ...
  `owner_id` int UNSIGNED NOT NULL DEFAULT '0',
  `trip_id` int UNSIGNED NOT NULL DEFAULT '0',
  `counter_manager_id` int UNSIGNED NOT NULL DEFAULT '0',
  `source_destination` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pick_up_point` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dropping_point` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `seats` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `passenger_details` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `ticket_count` int UNSIGNED DEFAULT '0',
...
CREATE TABLE `counters` (
  `id` bigint UNSIGNED NOT NULL,
  `owner_id` int UNSIGNED NOT NULL DEFAULT '0',
  `counter_manager_id` int UNSIGNED DEFAULT '0',
  `name` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `counter_managers`
--
...
CREATE TABLE `deposits` (
  `id` bigint UNSIGNED NOT NULL,
  `owner_id` int UNSIGNED NOT NULL DEFAULT '0',
  `sold_package_id` int UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE `fleet_types` (
  `id` bigint UNSIGNED NOT NULL,
  `owner_id` int UNSIGNED NOT NULL DEFAULT '0',
  `seat_layout_id` int UNSIGNED NOT NULL DEFAULT '0',
  `name` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `owners` (
  `id` bigint UNSIGNED NOT NULL,
  `general_settings` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `firstname` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lastname` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `username` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `ver_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'stores verification code',
...
CREATE TABLE `owner_logins` (
  ...
  `city` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `owner_ip` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `location` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `packages` (
  ...
  `unit` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1 = Day, 2 = Month, 3 = Year',
  `status` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `sold_packages` (
  ...
  `status` tinyint(1) DEFAULT '0' COMMENT '0 = Payment Incomplete, 1 = Active, 2 = Expired',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `trips` (
  ...
  `starting_point` int UNSIGNED NOT NULL DEFAULT '0',
  `destination_point` int UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Indexes for table `counter_managers`
--
ALTER TABLE `counter_managers`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `counter_managers_username_unique` (`username`),
  ADD UNIQUE KEY `counter_managers_email_unique` (`email`);

--
-- Indexes for table `co_owners`
--
ALTER TABLE `co_owners`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `co_admins_username_unique` (`username`),
  ADD UNIQUE KEY `co_admins_email_unique` (`email`);
...
ALTER TABLE `supervisors`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `supervisors_username_unique` (`username`),
...
ALTER TABLE `vehicles`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `buses_registration_no_unique` (`registration_no`),
  ADD UNIQUE KEY `buses_engine_no_unique` (`engine_no`),
  ADD UNIQUE KEY `buses_chasis_no_unique` (`chasis_no`);
...
--
-- AUTO_INCREMENT for table `counter_managers`
--
ALTER TABLE `counter_managers`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `co_owners`
--
ALTER TABLE `co_owners`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
